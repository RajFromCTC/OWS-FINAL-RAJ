...
def analyze_adx(image_path):
    ...
    "CONFIDENCE (brief deterministic rule, 1–10 integer ONLY):\n"
    ...
    " - Clamp to 1..10.\n"
    " - Hard cap: if (is_adx_above_20 is False OR null) AND (tci_cross == NONE) AND (close_confirmation is not CONFIRMED_*) => confidence MUST be 1..3.\n\n"
